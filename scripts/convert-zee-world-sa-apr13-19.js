...
const wb = XLSX.readFile('TV Schedules/Zee World/April/Zee World APRIL 2026 FPC SA (April 13th - 19th) Edited.xlsx', { cellDates: true });
...
for (const r of rows) {
  ...
  if (!dateStr || !title || !start || !end || timezone !== 'CAT') continue;
...
const outputPath = 'public/zee-world-sa-apr13-19-tvguide.json';
fs.writeFileSync(outputPath, JSON.stringify(tvGuideData, null, 2), 'utf8');

console.log('✅ Done!');
console.log('📁 Output:', outputPath);
console.log('📊 Shows placed:', placed);
