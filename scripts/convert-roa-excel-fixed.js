...
function convertROAExcelFixed() {
  console.log('🚀 Starting ROA Excel to JSON conversion (Fixed Version)...');
  ...
  // Write to file
  const outputPath = './public/roa-guide-fixed.json';
