...
function convertROAExcelPerfect() {
  console.log('🚀 Starting ROA Excel to JSON conversion (Perfect Version)...');
  ...
  // Write to file
  const outputPath = './public/roa-guide-perfect.json';
