...
function convertROAExcelFinalFix() {
  console.log('🚀 Starting ROA Excel to JSON conversion (Final Fix)...');
  ...
  // Write to file
  const outputPath = './public/roa-guide-final-fix.json';
