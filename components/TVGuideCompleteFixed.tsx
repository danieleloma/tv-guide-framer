/**
 * Complete Fixed TV Guide Framer Component
 * 
 * Fixes all issues:
 * - Consistent time interval widths (30-min slots are half width of hourly slots)
 * - Proper show slot width alignment with time grid
 * - All days show content directly underneath each other
 * - Restored SA region functionality
 * - Complete time coverage with proper positioning
 */
...
function generateSATimeTicks(hourWidthPx: number) {
    const ticks = []
    const halfHourWidth = hourWidthPx / 2
...
export default function TVGuideCompleteFixed(props: TVGuideProps) {
                                        ...
                                        <div
                                            ...
                                            style={{
                                                width: tick.isMajor
                                                    ...
                                                    : (props.hourWidthPx || 220) / 2, // FIXED: 30-min slots are half width
                                                padding: "12px 8px",
                                                textAlign: "center",
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        top: 4,
                                                        height: rowHeight - 8,
                                                        width: Math.max(60, width - 4), // FIXED: Proper width calculation
...
addPropertyControls(TVGuideCompleteFixed, {
    // JSON inputs for both regions
    saDataJSON: {
