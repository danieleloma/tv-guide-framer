/**
 * Complete TV Guide Framer Component
 * 
 * This component demonstrates the structured TV Guide system with:
 * - Separate JSON inputs for SA and ROA regions
 * - Proper time structures for each region/timezone
 * - Monday-based week starting
...
// Sample data for demonstration (you can replace with your actual data)
const sampleSAData = {
  "metadata": {
  ...
  "regions": [
    {
      ...
      "days": [
          ...
          "slots": [
            {
              ...
              "endISO": "2025-10-06T04:30:00.000Z",
              "title": "Ringside Rebel S1 EP 278",
              "durationMin": 30
            },
            {
              "startISO": "2025-10-06T04:30:00.000Z",
              "endISO": "2025-10-06T05:00:00.000Z",
              "title": "Twist of Fate: New Era S10 EP73",
              "durationMin": 30
            },
            {
              "startISO": "2025-10-06T05:00:00.000Z",
              "endISO": "2025-10-06T05:30:00.000Z",
        ...
        },
        {
          ...
          "slots": [
            {
              "startISO": "2025-10-07T04:00:00.000Z",
              "endISO": "2025-10-07T04:30:00.000Z",
              "title": "Ringside Rebel S1 EP 279",
              "durationMin": 30
            },
            {
              "startISO": "2025-10-07T04:30:00.000Z",
              "endISO": "2025-10-07T05:00:00.000Z",
...
export default function TVGuideComplete(props: TVGuideProps) {
  const [saData, setSaData] = useState<GuideData | null>(sampleSAData);
  const [roaData, setRoaData] = useState<GuideData | null>(sampleROAData);
...
addPropertyControls(TVGuideComplete, {
  // Separate JSON inputs for SA and ROA
  saDataJSON: {
