/**
 * Height Fixed TV Guide Framer Component
 *
 * This component fixes the show slot height to stay within the allotted day row.
...
export default function TVGuideHeightFixed(props: TVGuideProps) {
    ...
    useEffect(() => {
        if (props.saDataJSON) {
            try {
                ...
                setSaData(jsonData)
                console.log("SA Data loaded:", jsonData)
            } catch (error) {
    ...
    const currentRegionData = combinedData.regions.find(
    ...
    return (
        <div
            style={{
                ...
                color: props.cardText || "#ffffff",
                fontFamily:
                    props.fontFamily || "system-ui, -apple-system, sans-serif",
                overflow: "hidden",
            }}
        >
            {/* Header Controls */}
            ...
            >
                {/* Region Switcher */}
                {props.enableRegionSwitch &&
                    combinedData.regions.length > 1 && (
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        border:
                                            currentRegion === region.code
                                                ? "none"
                                                : `1px solid ${props.gridLineColor || "#1a1a1a"}`,
                                    }}
                                >
                                    {region.label}
                                </button>
            ...
            <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
                ...
                >
                    ...
                    {currentRegionData.days.map((day, index) => {
                        const isCurrentDay =
                            props.showCurrentDay && day.dateISO === currentDate
                        return (
                            <div
                                key={day.dateISO}
                                style={{
                            ...
                            >
                                {new Date(day.dateISO).toLocaleDateString(
                                    "en-US",
                                    {
                                        weekday: "short",
                                        day: "numeric",
                ...
                >
                                    ...
                                    {timeTicks.map((tick, index) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                textAlign: "center",
                                                fontSize:
                                                    props.timeFontSize || 12,
                                                fontWeight: tick.isMajor
                                                    ? 600
                                                    : 400,
                                                borderRight: `1px solid ${props.gridLineColor || "#1a1a1a"}`,
                    ...
                    {/* Program Grid - FIXED HEIGHT STRUCTURE */}
                    <div
                        style={{
                            display: "flex",
                            minWidth: "max-content",
                    ...
                    >
                        {currentRegionData.days.map((day, dayIndex) => {
                            const isCurrentDay =
                                props.showCurrentDay &&
                                day.dateISO === currentDate
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        height:
                                            rowHeight *
                                            currentRegionData.days.length, // Total height for all days
                                ...
                                >
                                    ...
                                    {/* Day Row Container - FIXED HEIGHT */}
                                    <div
                                        style={{
                                            position: "absolute",
                                            ...
                                            height: rowHeight,
                                            borderBottom: `1px solid ${props.gridLineColor || "#1a1a1a"}`,
                                            overflow: "hidden", // Prevent show cards from extending beyond this row
                                        }}
                                    >
                                        {day.slots.map((slot, slotIndex) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        position: "absolute",
                                                        left: left + 2, // Small margin from grid line
                                                        top: 4,
                                                        height: rowHeight - 8, // FIXED: Height matches row height minus padding
                                                        width: Math.max(
                                                            60,
                                                            width - 4
                                                        ), // Minimum width of 60px, subtract margin
                                                        backgroundColor:
                                                            slot.bgColor ||
                                                            props.cardBg ||
                                                            "#1a1a1a",
...
addPropertyControls(TVGuideHeightFixed, {
    // Separate JSON inputs for SA and ROA
    saDataJSON: {
        type: ControlType.String,
        title: "SA Data JSON",
        description:
            "JSON data for South Africa region (CAT timezone, 6:00 AM - 5:30 AM)",
    },
    roaDataJSON: {
        type: ControlType.String,
        title: "ROA Data JSON",
        description:
            "JSON data for Rest of Africa region (WAT: 5:00 AM - 4:00 AM, CAT: 6:00 AM - 5:00 AM)",
    },
