/**
 * Aligned TV Guide Framer Component
 * 
 * This component fixes the show slot positioning to properly align with the time grid.
...
export default function TVGuideAligned(props: TVGuideProps) {
              ...
              return (
                ...
                >
                  ...
                  {day.slots.map((slot, slotIndex) => {
                    ...
                    // Calculate position based on region and timezone - FIXED CALCULATION
                    let left = 0;
                    if (currentRegion === "SA") {
                    ...
                    // FIXED: Calculate width based on actual duration, not screen width
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          top: 4,
                          bottom: 4,
                          width: Math.max(60, width - 4), // Minimum width of 60px, subtract margin
...
addPropertyControls(TVGuideAligned, {
  // Separate JSON inputs for SA and ROA
  saDataJSON: {
